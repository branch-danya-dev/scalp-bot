...
Последняя правка: [первая фиксация в пределах оценённого хода и выход из затухшего пробоя](docs/breakout-exit-plan.md).
[Текущее подтверждение](docs/breakout-current-response.md), [свежесть эпизода и
автоматическое сохранение capture](docs/breakout-opportunity-freshness.md) сохраняются.
Следующий шаг по решению владельца — [24-часовой paper-экзамен текущего состава](docs/paper-exam-24h.md).
Финансовый критерий: net ≥10% от стартовых 1000 USDT за полные сутки; риск не повышается.

## Навигация

- [Текущий экзамен: 24 часа, состав стратегий, риск и критерий +10% net](docs/paper-exam-24h.md).
