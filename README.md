...
Последняя правка: [ценовой эпизод пробоя отделён от свежести готового сигнала;
capture сохраняется автоматически после остановки торговли](docs/breakout-opportunity-freshness.md).
